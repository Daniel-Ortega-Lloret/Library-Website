...
<body class="mainBody">
    <div class="whiteBox">
        <h1>Are you sure you want to reserve the following books?</h1>
        <?php
            session_start();
            ...
            {
                header("Location: ../HTML + PHP/bookSearch.php?error=1&page=" . $_SESSION["page"]);
                exit();
            }
            
            echo "<form action='../HTML + PHP/reservation.php' method='post'>";
            ...
            echo "</table><br />";
            echo '<input class="sureButton" type="submit" value="Reserve">';
            echo '<a class="sureButton browseNow" href="../HTML + PHP/bookSearch.php?page=1">Go Back</a>';
            echo "</form>";
        ?>
    </div>
</body>
